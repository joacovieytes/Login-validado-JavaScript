document.addEventListener('DOMContentLoaded', function (){
    ...
    function validateEmail() {
        ...
        const emailValue = emailInput.value.trim(); //el trim elimina espacios vacios al inicio y final del input
    ...
    function validatePasswordMatch() {
        ...
        if (passwordValue != confirmPasswordValue) {
            showError(confirmPasswordError, 'Los password no coinciden!');
            return false;
        }
